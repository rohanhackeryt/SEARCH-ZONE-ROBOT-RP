...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6150580424').split()]
...
SHORTLINK_API = environ.get('SHORTLINK_API', '1e1a79468e690b90a634ee939fb546981ef07b9c')
...
URL = "https://muddy-annabela-rohanhacker90.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://muddy-annabela-rohanhacker90.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://muddy-annabela-rohanhacker90.koyeb.app/".format(FQDN)
else:
    URL = "https://muddy-annabela-rohanhacker90.koyeb.app/".format(FQDN)
